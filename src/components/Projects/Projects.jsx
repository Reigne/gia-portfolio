...
const Projects = () => {
  ...
  return (
    <div
      id="projects"
      className="min-h-screen bg-gray-50 font-poppins px-[180px] py-8 overflow-hidden"
    >
      ...
      >
        <p className="text- bg-purple-400 text-white px-6 rounded-full w-fit">
          SHORT-FORM
        </p>
      ...
      >
        ...
        <div className="flex justify-between items-center gap-2">
          <motion.div
            ...
            animate={isInViewAds ? { y: 0, opacity: 1 } : {}}
            transition={{ duration: 1.4 }}
            className="relative w-[380px] h-[380px] bg-zinc-200 rounded"
          >
